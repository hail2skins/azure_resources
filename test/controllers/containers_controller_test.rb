...
class ContainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create container" do
    assert_difference('Container.count') do
      post containers_url, params: { container: { last_modified: @container.last_modified, name: @container.name, public_access: @container.public_access } }
    end
  ...
  test "should update container" do
    patch container_url(@container), params: { container: { last_modified: @container.last_modified, name: @container.name, public_access: @container.public_access } }
